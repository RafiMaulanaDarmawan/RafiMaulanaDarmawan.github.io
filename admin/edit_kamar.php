              ...
              <div class="card-body">
                <form method="post" action="update_kamar.php" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $data['type_kamar']; ?>" name="type_kamar" placeholder="Type Kamar">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="card-body">
                <form method="post" action="harga_kamar.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>Harga_kamar</label>
                    <input name="harga_kamar" value="<?php echo $data['harga_kamar']; ?>" hidden>
                    <input type="text" class="form-control" value="<?php echo $data['harga_kamar']; ?>" name="harga_kamar" placeholder="Harga Kamar">
                  </div>

    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="resepsionis.php" class="nav-link active">Kembali</a>
            </li>
          </ul>
        </div>
      </div>
                  ...
                  <tbody>
                    ...
                    while($d = mysqli_fetch_array($data)){
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          while ($a = mysqli_fetch_array($kamar)) {
                            if ($a['id_kamar'] == $d['id_kamar']) { ?>
                              <?php echo $a['type_kamar']; ?>
                              <?php echo $a['harga_kamar']; ?>
                              <?php 
                            }
                          }
                          ?>
                        ...
                        <td>
                          <form action="aksi_batal.php" method="POST">
                            <input type="hidden" name="id_pesanan" value="<?php echo $d['id_pesanan']; ?>">
                            <input type="hidden" name="status" value="cancel">
                            <button class="btn btn-sm btn-primary"><i class="fas fa-ban"></i></button>
                          </form>
                        </td>
                        <td>
